...
<p>
	...
	<a href="javascript:$('#fileUpload').fileUploadStart()">Começar upload</a>
</p>
<p>&nbsp;</p>
...
<p>
	...
	<a href="javascript: void(null)" onClick="javascript:$('#fileUpload2').fileUploadStart()">Começar upload</a> | <a href="javascript:$('#fileUpload2').fileUploadClearQueue()">Limpar Fila</a>
</p>
<p>&nbsp;</p>
